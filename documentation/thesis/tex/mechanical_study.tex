...
Note that the maximum torque of the motor is a function of velocity and in particular at max speed the torque is zero.
...
\end{enumerate}
\subsubsection{Inclination ($\alpha > 0$)}
