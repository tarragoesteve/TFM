...
that fullfiled the requirements and restrictions.

\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{img/optimization/parameters.png}
	\caption{Plot of the wheel radius and the width of the cylinder that waas optimal for each flywheel radius.}
	\label{fig:Parameters plot}
\end{figure}

We can observe that the relation between the flywheel radius and 
the wheel radius is linear. This is becouse we are always on the
...
linearly with the flywheel radius. This is becouse it is linearly related with
the wheel radius.
